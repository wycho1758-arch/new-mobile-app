...
Use this Product/Planning adapter before PRD decomposition when a request is too unclear to become execution work.
...
- User request, rough idea, partial PRD, Jira request, Confluence brief, or feature room note.
...
5. Flag human gates for production submit, payment, PII, external messaging, legal/terms, or risk acceptance.
...
- Human gates and evidence requirements.
