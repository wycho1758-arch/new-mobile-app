...
for (const required of [
  ...
  'evals/skills/codex-role-workflow/interactive-codex-contract-positive.prompt.md',
  'evals/skills/codex-role-workflow/direct-agent-edit-negative.prompt.md',
  'evals/skills/codex-interactive-repo-work/positive.prompt.md',
