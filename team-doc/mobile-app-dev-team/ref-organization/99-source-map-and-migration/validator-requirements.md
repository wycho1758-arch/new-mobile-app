...
1. `team-doc/mobile-app-dev-team/ref-organization/README.md` exists after Checkpoint 2.
...
7. Crosswalk targets must be under `team-doc/mobile-app-dev-team/ref-organization/` unless the row is `drop-with-reason`.
