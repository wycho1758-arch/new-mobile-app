...
Generated at: 2026-06-13T09:17:01.475Z
Report: /var/folders/q9/m8qpcc0n2zd5w9t5tg9r9f8w0000gn/T/tmp.nll5BM6mV9/state/project-bootstrap-report.json
Repo path: /var/folders/q9/m8qpcc0n2zd5w9t5tg9r9f8w0000gn/T/tmp.nll5BM6mV9/repo
...
- `human-gate/v1` 승인이 필요한 외부/위험 작업이 포함되어 있습니다.
...
- 필요한 입력이 준비되면 관련 setup과 `project-bootstrap` preflight를 다시 실행하겠습니다.

### 사용자에게 필요한 최소 작업

- 정확한 action과 evidence path가 적힌 `human-gate/v1` 결정을 연결해 주세요.
...
- Blockers: `pod-role-bootstrap blocked`, `human-gate/v1 required`.
