...
Generated at: 2026-06-13T09:17:01.932Z
Report: /var/folders/q9/m8qpcc0n2zd5w9t5tg9r9f8w0000gn/T/tmp.TRRb7zG39P/state/project-bootstrap-report.json
Repo path: /var/folders/q9/m8qpcc0n2zd5w9t5tg9r9f8w0000gn/T/tmp.TRRb7zG39P/repo
...
- package-manager 상태를 확인했습니다. repo SoT는 `package.json`과 `pnpm-lock.yaml`이며 pin은 `pnpm@9.15.9`입니다.
...
- `package.json`, `pnpm-lock.yaml`, `corepack --version`, `pnpm --version`를 기준으로 package-manager 상태를 확인합니다.
...
- Blockers: `pod-role-bootstrap blocked`, `pnpm-pin-mismatch`.
