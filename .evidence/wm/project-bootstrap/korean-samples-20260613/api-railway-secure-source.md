...
Generated at: 2026-06-13T09:17:01.780Z
Report: /var/folders/q9/m8qpcc0n2zd5w9t5tg9r9f8w0000gn/T/tmp.FOgLa8kcmC/state/project-bootstrap-report.json
Repo path: /var/folders/q9/m8qpcc0n2zd5w9t5tg9r9f8w0000gn/T/tmp.FOgLa8kcmC/repo
...
- 보안 credential source 또는 conditional login/auth 준비가 필요합니다.
...
- 승인된 source가 준비되면 redacted status-only setup report를 다시 만들고 비밀값 없이 다음 단계를 진행하겠습니다.

### 사용자에게 필요한 최소 작업

- Secret, secure store, tool auth, mounted file, human-present login 중 승인된 보안 credential source를 준비해 주세요.
...
- Blockers: `pod-role-bootstrap blocked`, `api-railway-secure-source-missing`.
