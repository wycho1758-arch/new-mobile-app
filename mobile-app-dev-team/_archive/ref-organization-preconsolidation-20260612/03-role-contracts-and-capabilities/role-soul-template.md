...
- `mobile-app-dev-team/ref-organization/01-organization-model/gatekeeper-model.md`

Downstream consumers:

- Future role SOUL.md authoring work.
- Capability matrix and handoff responsibility pages.
