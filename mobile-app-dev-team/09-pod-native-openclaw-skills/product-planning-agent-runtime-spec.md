...
`mobile-app-dev-team/02-role-souls/product-planning-soul.md` must set itself up
...
append `mobile-app-dev-team/19-entry-case-routing.md`.

If `mobile-app-dev-team/19-entry-case-routing.md` cannot be read from the
