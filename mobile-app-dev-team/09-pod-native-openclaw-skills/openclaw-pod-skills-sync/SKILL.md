...
`mobile-app-dev-team/09-pod-native-openclaw-skills` into the runtime snapshot
...
- Source root:
  `/workspace/projects/Wondermove-Inc/new-mobile-app/mobile-app-dev-team/09-pod-native-openclaw-skills`
